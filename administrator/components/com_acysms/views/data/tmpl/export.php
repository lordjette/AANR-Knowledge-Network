		...
		<div class="<?php echo $divClass; ?>">
			...
			<table class="acysms_blocktable" cellpadding="1">
				<tbody>
					...
					<tr id="userField_excel">
						<td>
							<?php echo ACYSMS::tooltip(JText::_('SMS_EXCEL_SECURITY_DESC'), JText::_('SMS_EXCEL_SECURITY'), '', JText::_('SMS_EXCEL_SECURITY')); ?>
						</td>
						<td align="center" style="text-align:center">
							<?php echo JHTML::_('acysmsselect.booleanlist', "export_excelsecurity", null, $this->config->get('export_excelsecurity', 0) == 1 ? 1 : 0); ?>
						</td>
					</tr>
				</tbody>
			</table>
