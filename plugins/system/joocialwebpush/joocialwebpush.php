...
class PlgSystemJoocialWebpush extends JPlugin
{
	...
	protected function renderOnesignalWebpush()
	{
		...
		$document = JFactory::getDocument();
		$document->addScript('https://cdn.onesignal.com/sdks/OneSignalSDK.js', 'text/javascript', false, true);
	...
	protected function renderPushwooshWebpush()
	{
		...
		$document = JFactory::getDocument();
		$document->addScript('https://cdn.pushwoosh.com/webpush/v3/pushwoosh-web-notifications.js', 'text/javascript', false, true);
		$document->addScriptDeclaration($script);
	}
