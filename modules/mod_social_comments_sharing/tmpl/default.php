...
if($params->get('module_style')=='horizontal' || $params->get('module_style')=='vertical'){
    ...
    if ($enable_share) {
        ...
        $htmlCode.= "<div style=\"margin-right:4px;\" class=\"fb_share_button_container\">$tmp</div>";
...
//Google +1 button
    if ($enable_google == 1) {
        ...
        $tmp = "";
        $tmp.= "<div class=\"g-plusone\" data-size=\"medium\" data-href=\"$url\" data-annotation=\"$annotation_google\"></div>".PHP_EOL;
